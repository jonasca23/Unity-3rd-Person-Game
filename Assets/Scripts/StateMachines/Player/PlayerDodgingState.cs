...
{    
    ...
    public PlayerDodgingState(PlayerStateMachine _stateMachine, Vector3 _dodgingDirectionInput): base(_stateMachine)
    {
        dodgingDirectionInput = _dodgingDirectionInput;
    }
